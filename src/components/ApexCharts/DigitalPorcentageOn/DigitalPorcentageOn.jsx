   ...
   //console.log(data[0]);
    ...
    return (
        <>
            ...
            {`Grafico del canal "${currentChannel.nombre}". Cada punto del grafico integra los valores de las lecturas de los ultimos ${currentChannel.tiempo_a_promediar} minutos.`}
            </p>
            <Chart 
